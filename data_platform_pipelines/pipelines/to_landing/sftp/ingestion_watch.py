...
from data_platform_pipelines.pipelines.utils.sftp.watch_collector import (
    WatchCollector,
)
...
def collect_data(
    ...
    **credentials,
    ...
    # Inicializando o objeto coletor da classe WatchCollector
    collector = WatchCollector(**credentials)
